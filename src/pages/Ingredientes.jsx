...
export default function Ingredientes() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-pink-600 mb-6">Gestión de ingredientes</h1>
      ...
      <form onSubmit={guardar} className="bg-white rounded-2xl shadow-sm p-5 mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex gap-2 sm:col-span-2 lg:col-span-3">
          <button type="submit" className="bg-pink-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-pink-700">
